function [U_avg,U_rms,I_avg_L1,I_avg_L2,I_rms_L1,I_rms_L2,...
        ...
        RMS_Ripple_Factor_L2,Peak_Ripple_Factor_L2,...
        Dip,Swell,Interruption,...
        U_rms_10ms,I_rms_L1_10ms,I_rms_L2_10ms,...
        U_rms_20ms,I_rms_L1_20ms,I_rms_L2_20ms,MLPath,DTPath,leftover]...
        = evaluator_1voltage2current(num,listing,sample_window_length,group_size,Fs,Ts,U_avg,U_rms,...
        I_avg_L1,I_avg_L2,I_rms_L1,I_rms_L2,isNonStatDistOccur,...
...
% gain.
L1_Voltage=Recordings(:,2);
L1_Current=Recordings(:,3);
L2_Current=Recordings(:,4);
...
%         Data_L2_Current(sample_window_length*num_Sample + 1:end)); % Generate this files's leftover
