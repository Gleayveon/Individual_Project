...
figure(1)
    subplot(2,2,1)
        ...
        yyaxis left
        plot(time_5MS(1:10000),U_avg(1:10000),'Color','#633736');
        ylabel('V')
        yyaxis right
        plot(time_5MS(1:10000),I_avg_L1(1:10000),'Color','#C31E2D');
        hold on
        plot(time_5MS(1:10000),I_avg_L2(1:10000),'Color','#2773C8');
        hold on
        plot(time_5MS(1:10000),I_avg_L3(1:10000),'Color','#9CC38A');
        ylabel('A')
        xlabel('time')         
    ...
    subplot(2,2,2)
        yyaxis left
        plot(time_5MS(1:10000),U_rms(1:10000),'Color','#633736');
        ylabel('V')
        yyaxis right
        plot(time_5MS(1:10000),I_rms_L1(1:10000),'Color','#C31E2D');
        hold on
        plot(time_5MS(1:10000),I_rms_L2(1:10000),'Color','#2773C8');
        hold on
        plot(time_5MS(1:10000),I_rms_L3(1:10000),'Color','#9CC38A');
        ylabel('A')
        xlabel('time')         
        legend('Voltage','Line 1','Line 2','Line 3');
        hold off
    ...
    subplot(2,2,3)
        yyaxis left
        plot(time_5MS(1:10000),U_ripple(1:10000),'Color','#633736');
        ylabel('V')
        yyaxis right
        plot(time_5MS(1:10000),I_ripple_L1(1:10000),'Color','#C31E2D');
        hold on
        plot(time_5MS(1:10000),I_ripple_L2(1:10000),'Color','#2773C8');
        hold on
        plot(time_5MS(1:10000),I_ripple_L3(1:10000),'Color','#9CC38A');
        ylabel('A')
        xlabel('time')         
        legend('Voltage','Line 1','Line 2','Line 3');
        hold off
    ...
    subplot(2,2,4)
        ...
        yyaxis left
        plot(time_200MS(1:250),RDF_Voltage(1:250),'Color','#633736');
        ylabel('V')
        yyaxis right
        plot(time_200MS(1:250),RDF_L1(1:250),'Color','#C31E2D');
        hold on
        plot(time_200MS(1:250),RDF_L2(1:250),'Color','#2773C8');
        hold on
        plot(time_200MS(1:250),RDF_L3(1:250),'Color','#9CC38A');
        ylabel('A')
        xlabel('time')         
        legend('Voltage','Line 1','Line 2','Line 3');
        hold off
