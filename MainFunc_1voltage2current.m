...
clear
close all
config = readlines("config_nd.csv"); %The configure file name
MLPath = config(2);
DTPath = config(3);
...
%% Data Analysis
% for num = 1:len
    [U_avg,U_rms,I_avg_L1,I_avg_L2,I_rms_L1,I_rms_L2,...
...
%% Overall Display
filename = string(listing(num).name);
fprintf('%s\n',filename);
